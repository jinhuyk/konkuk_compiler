...
{
       0,    51,    51,    52,    56,    57,    58,    66,    67,    68,
      72,    73,    77,    84,    88,    89,    90
};
#endif
...
{
       2,     0,     1,    14,    15,     4,     0,     3,     0,     9,
      13,     0,    15,     0,     0,     0,     5,     0,     0,     0,
       0,    16,     7,     8,    10,    11,    12,     6
};
...
{
       2,     3,    12,     3,     4,    11,    14,    15,    13,     5,
       6,     0,     6,    20,    21,    14,    15,    22,    23,    16,
      17,    18,    14,    15,    19,     0,    27,     0,    24,    25,
      26
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     3,     4,    10,     5,     6,     6,     9,
      12,    -1,    12,    11,    13,     5,     6,    14,    15,     9,
       7,     8,     5,     6,    11,    -1,     9,    -1,    17,    18,
      19
};
...
{
       0,    15,     0,     3,     4,     9,    12,    16,    17,    18,
      19,    10,     4,    17,     5,     6,     9,     7,     8,    11,
      17,    13,    18,    18,    19,    19,    19,     9
};
...
#line 1109 "parser.tab.c"
  ...
  case 6: /* line: IDENT '=' expr '\n'  */
#line 58 "parser.y"
                         {
          setvar((yyvsp[-3].id), (yyvsp[-1].num));
...
#line 73 "parser.y"
                         {
          if ((yyvsp[0].num) == 0) { fprintf(stderr, "division by zero\n"); (yyval.num) = 0.0; }
...
#line 77 "parser.y"
                      {
        if ((int)(yyvsp[-2].num) == (yyvsp[-2].num) && (int)(yyvsp[0].num)==(yyvsp[0].num) ){
...
#line 89 "parser.y"
                         { (yyval.num) = getvar((yyvsp[0].id)); free((yyvsp[0].id)); }
